  ...
  return (
    ...
    <footer id="footer">
      <div className="leftFooter">
        ...
        <a href="https://play.google.com/store/apps/details?id=com.plarium.raidlegends"><img src={playStore} alt="playstore" /></a>
        <a href="https://play.google.com/store/apps/details?id=com.plarium.raidlegends"><img src={appStore} alt="Appstore" /></a>
        </div>
